@echo off
chcp 65001 >nul
echo Creating word_progress and daily_word_stats tables...

mysql -uroot -p20040821 aistudy --default-character-set=utf8 -e "CREATE TABLE IF NOT EXISTS word_progress (
...
mysql -uroot -p20040821 aistudy --default-character-set=utf8 -e "CREATE TABLE IF NOT EXISTS daily_word_stats (
  id bigint NOT NULL AUTO_INCREMENT,
